<?php
require_once GP_PLUGIN_DIR . 'includes/pays/libs/wechat/lib/WxPay.Exception.php';
require_once GP_PLUGIN_DIR . 'includes/pays/libs/wechat/lib/WxPay.Config.php';
require_once GP_PLUGIN_DIR . 'includes/pays/libs/wechat/lib/WxPay.Data.php';
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if(!$inputObj->IsNotify_urlSet()){
			$inputObj->SetNotify_url( gp_get_pays_weichat_notify_url() );//异步通知url
		}
		
		$inputObj->SetAppid( gp_get_pays_wechat_app_id() );//公众账号ID
		$inputObj->SetMch_id( gp_get_pays_wechat_mchid() );//商户号
